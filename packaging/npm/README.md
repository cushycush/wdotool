...
console.log(raw.backend.selected); // "libei" | "wlr-protocols" | ...
...
- `backend`. Which backend was selected (libei, wlr-protocols, kde, gnome, uinput) and the fallback chain the detector considered.
